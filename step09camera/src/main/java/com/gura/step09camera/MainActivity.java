...
public class MainActivity extends AppCompatActivity
    ...
    public void requestTakePic(){
        ...
        if(intent.resolveActivity(getPackageManager())!=null){  //null이 아니면 가능하다는 뜻.
            ...
            if(photoFile!=null){
                ...
                Uri uri= FileProvider.getUriForFile(this, "com.gura.step09camera.fileprovider", photoFile);     // 파일이 있는 경로를 uri로 변환해서 가져온다    app의 패키지명.fileprovider

                Log.i("uri", uri.getPath());
                //인텐트에 Uri 객체를 담고
                intent.putExtra(MediaStore.EXTRA_OUTPUT, uri);
                //결과를 받아올수 있는 액티비티 시작 시키기   (카메라앱 실행)
    ...
    @Override   //사진을 찍고나면 생기는 결과가 들어오는 메서드.
    ...
    public static void fitToImageView(ImageView imageView, String absolutePath){
        ...
        Bitmap bitmap = BitmapFactory.decodeFile(absolutePath, bmOptions);      //imageView 에 출력.
